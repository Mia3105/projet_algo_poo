...
class Etres_vivants(ActorSpriteDrivenBySpeed):
    ...
    def creer(self, classe, individus_sprites: pygame.sprite.Group, actors_sprites: pygame.sprite.Group, 
              surface: pygame.Surface, nbre_a_cree: int, liste_positions_all_individus: list = [],) -> None :
...
class Animaux(Etres_vivants):
    ...
    def predateur_mange_proie(self, predateurs_sprites: pygame.sprite.Group, proies_sprites: pygame.sprite.Group) -> None :
    ...
    def reproduction(self, classe, individus_sprites, actors_sprites, surface) -> None :
