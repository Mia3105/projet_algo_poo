...
WINDOW_TITLE: str = "pygame window 08"
FPS: int = 12
...
class ActorDrivenBySpeed(Actor):
    def __init__(self, position: pygame.Vector2, speed: pygame.Vector2, dimension: Tuple[int, int]) -> None:
        super().__init__(position, speed, dimension)
...
class App:
    ...
    def __init_actors(self) -> None:
        ...
        actor: ActorDrivenBySpeed = ActorDrivenBySpeed(pygame.Vector2(210, 160), random_speed, (60, 40))
